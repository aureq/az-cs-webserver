        ...
        var vm = new VirtualMachine("server-vm",
            new VirtualMachineArgs
            {
                ...
                OsProfile = new VirtualMachineOsProfileArgs
                {
                    ...
                    AdminPassword = stackConfig.Require("adminpassword"),
                    // AdminPassword = "HardCodedPassword1234!isBad",
                    CustomData =
                        @"#!/bin/bash
...
nohup python -m SimpleHTTPServer 80 &"
        ...
        this.WgetCommand = this.IpAddress.Apply(ip => "Run 'wget -q -O - -S http://" + ip + "' to test your web server.");
    }
